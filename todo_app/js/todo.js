...
function get_todos() {
    ...
    /* if the input is not null then JSON.parse will communicate with th eweb  browser to  make the task a JavaScript object.*/
    if (todos_str !== null) {
...
function show() {
    ...
    var html = '<ul>';
    /* this displays a task to th elist in the order that it is inputed*/
...
/* this displays the inputed task when the 'add item' buttonn is clicked*/
